...
import main.be.kdg.bagageafhandeling.transport.services.RecordOption;
...
public class Main {
    public static void main(String[] args) {
        ...
        TimePeriod p1 = new TimePeriod(13, 18, 2000);
        ...
        BagageScheduler bagageScheduler = new BagageScheduler(f.getCurrentTimePeriod(), "C:\\Users\\Michiel\\Desktop\\test.xml", RecordOption.XML);
